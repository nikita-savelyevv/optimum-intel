...
class OVExportCommand(BaseOptimumCLICommand):
    ...
    def run(self):
        from ...exporters.openvino.__main__ import main_export, main_export_and_quantize
        ...
        # We apply main_export_and_quantize only if quantization_config is explicitly provided and it is not a GPT-OSS
        # workaround config. Otherwise, quantization can still be applied inside main_export if a model has more than 1B parameters.
